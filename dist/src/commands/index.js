...
export async function indexCommand() {
    ...
    console.log('\n');
    if (errors > 0) {
        console.log(chalk.yellow(`Rebuilt with warnings: ${indexed} indexed, ${errors} errors (${elapsed}s)`));
    }
    else {
        console.log(chalk.green(`✓ Index rebuilt: ${indexed} memories indexed (${elapsed}s)`));
    }
}
